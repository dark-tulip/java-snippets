...
- позволяет отслеживать изменения данных в базе данных (например, вставки, обновления и удаления записей) и передавать эти изменения в другие системы в режиме реального времени.
- ранее решалось триггерами в базе данных или периодическая выборка данных, что имело ряд недостатков:
...
- MySQL, PostgreSQL, MongoDB, Oracle, SQL Server, и
- использует единую модель для передачи данных в Kafka
