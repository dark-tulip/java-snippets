// CopyOnWriteArrayList - когда чтений намного больше чем записей
// создает старую копию по которой безболезненно итерируются
// затем ссылку заменяет на новый список
